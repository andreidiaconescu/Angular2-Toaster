...
// Mock component for bootstrapping <ang2-toaster-container></ang2-toaster-container>
@Component({
  selector: 'test-component',
  template:
    '<ang2-toaster-container [toasterconfig]="toasterconfig"></ang2-toaster-container>',
})
...
describe('ToasterContainerComponent with sync ToasterService', () => {
  ...
  it('removeToast calls onHideCallback if it exists', () => {
    ...
    const toast: Toast = {
      type: 'info',
      title: 'default',
      onHideCallback: (toastInstance) => (status = 'updated'),
    };
    toasterService.pop(toast);
...
describe('Multiple ToasterContainerComponent components', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.overrideComponent(TestComponent, {
      set: {
        template: `<ang2-toaster-container [toasterconfig]="toasterconfig"></ang2-toaster-container>
                    <ang2-toaster-container [toasterconfig]="toasterconfig2"></ang2-toaster-container>`,
      },
    });
